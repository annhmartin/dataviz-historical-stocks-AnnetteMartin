...
valid_tickers = [t for t in selected if t in daily_signals["ticker"].unique()]
if not valid_tickers:
    st.warning("No signal data for tickers in selected sector.")
    st.stop()
ticker    = col1.selectbox("Ticker", valid_tickers)
