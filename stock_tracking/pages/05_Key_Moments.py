...
valid_tickers = [t for t in selected if t in df_key_moves["ticker"].unique()]
if not valid_tickers:
    st.info("No key moves found for tickers in selected sector.")
    st.stop()

col1, col2 = st.columns(2)
ticker_km      = col1.selectbox("Ticker", valid_tickers)
